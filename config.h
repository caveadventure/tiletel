...
static const int ConfigParser_first_final = 105;
static const int ConfigParser_error = 0;

static const int ConfigParser_en_strchar_escape = 104;
...
tr21:
#line 131 "config.rl"
	{{ state.stack[ state.top++] = 13; goto st104;}}
	goto st13;
st13:
	if ( ++( state.p) == ( state.pe) )
		goto _test_eof13;
...
tr39:
#line 131 "config.rl"
	{{ state.stack[ state.top++] = 24; goto st104;}}
	goto st24;
st24:
	if ( ++( state.p) == ( state.pe) )
		goto _test_eof24;
...
tr66:
#line 131 "config.rl"
	{{ state.stack[ state.top++] = 45; goto st104;}}
	goto st45;
st45:
	if ( ++( state.p) == ( state.pe) )
		goto _test_eof45;
...
tr84:
#line 131 "config.rl"
	{{ state.stack[ state.top++] = 57; goto st104;}}
	goto st57;
st57:
	if ( ++( state.p) == ( state.pe) )
		goto _test_eof57;
...
tr130:
#line 131 "config.rl"
	{{ state.stack[ state.top++] = 92; goto st104;}}
	goto st92;
st92:
	if ( ++( state.p) == ( state.pe) )
		goto _test_eof92;

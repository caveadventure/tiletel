...
static const int ConfigParser_first_final = 115;
static const int ConfigParser_error = 0;

static const int ConfigParser_en_strchar_escape = 114;
...
tr22:
#line 131 "config.rl"
	{{ state.stack[ state.top++] = 13; goto st114;}}
	goto st13;
st13:
	if ( ++( state.p) == ( state.pe) )
		goto _test_eof13;
...
tr40:
#line 131 "config.rl"
	{{ state.stack[ state.top++] = 24; goto st114;}}
	goto st24;
st24:
	if ( ++( state.p) == ( state.pe) )
		goto _test_eof24;
...
tr67:
#line 131 "config.rl"
	{{ state.stack[ state.top++] = 45; goto st114;}}
	goto st45;
st45:
	if ( ++( state.p) == ( state.pe) )
		goto _test_eof45;
...
tr85:
#line 131 "config.rl"
	{{ state.stack[ state.top++] = 57; goto st114;}}
	goto st57;
st57:
	if ( ++( state.p) == ( state.pe) )
		goto _test_eof57;
...
tr131:
#line 131 "config.rl"
	{{ state.stack[ state.top++] = 92; goto st114;}}
	goto st92;
st92:
	if ( ++( state.p) == ( state.pe) )
		goto _test_eof92;
